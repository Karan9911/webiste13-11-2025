                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) === 'sessions.php' ? 'active' : ''; ?>" href="sessions.php">
                            <i class="bi bi-calendar-heart me-2"></i>Spa Sessions
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) === 'session_bookings.php' ? 'active' : ''; ?>" href="session_bookings.php">
                            <i class="bi bi-clipboard-check me-2"></i>Session Bookings
                        </a>
                    </li>
                    <li class="nav-item">
