...
<!-- Spa Session Packages Section -->
<section class="session-packages-section py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="section-title">Spa Session Packages</h2>
            <p class="text-muted">Choose from our premium spa session packages designed for ultimate relaxation</p>
        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="session-card">
                        ...
                        <div class="session-card-body">
                            <h5 class="session-card-title"><?php echo htmlspecialchars($session['name']); ?></h5>
                            <div class="session-card-meta">
                                <div class="session-time">
                                    <i class="bi bi-clock"></i>
                                    <?php echo htmlspecialchars($session['therapy_time']); ?>
                                </div>
                            ...
                            <p class="session-card-description">
                                <?php echo htmlspecialchars(substr($session['description'], 0, 80)); ?>...
                            </p>
                            <a href="session-details.php?id=<?php echo $session['id']; ?>" class="btn btn-primary btn-sm w-100">
